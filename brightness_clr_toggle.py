...
class ClrIntensityToggle:
    def __init__(self, master, io_mgr):
        self.master = master
        self.io_mgr = io_mgr
    ...
    def create_toggle_btn(self, icon_path, incrementing=False):
        ...
        callback = lambda : self.initiate_toggle(incrementing)
    ...
    def initiate_toggle(self, increment):
        self.io_mgr.page.update_brightness(increment)
